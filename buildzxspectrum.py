...
#CPM_CMDLINE = 0x0080
# we won't have a command line but we'll place our buffer there
CPM_CMDLINE = 0x6080
MAX_OUTPUT_LEN = 50  # Maximum characters to generate
# callback to print a character
CALLBACK_PRINTCHAR = 0x6003
...
def build_autoreg(model_path: str = 'command_model_autoreg.pt'):
    ...
    # === MAIN ===
    # ZX Spectrum operation acts like a commandline invocation
    # We expect the string to be passed in HL
    b.label('START')
    ...
    b.label('PRINTCH')
    # open ZX Spectrum channel 2 (upper screen)
    #b.ld_a_n(2)
    #b.call_addr(OPEN_CHAN)	# OPEN-CHAN
    b.ld_a_mem_label('RESULT')
    ...
    b.add_hl_bc()
    b.ld_a_hl()
    b.call_addr(CALLBACK_PRINTCHAR)
    #b.rst(16)
    #b.ld_e_a()
    #b.ld_c_n(2)  # BDOS console output
    #b.call_addr(BDOS)
